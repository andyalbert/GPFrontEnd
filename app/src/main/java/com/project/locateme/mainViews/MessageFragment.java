...
public class MessageFragment extends Fragment {
    ...
    @BindView(R.id.fragment_place_events_list)
    //RecyclerView eventRecyclerView;
            ListView eventsListView;
    @BindView(R.id.fragment_place_event_text)
    TextView eventText; //hidden by default, should be set to visible later
  //  @BindView(R.id.fragment_place_friends_list)
...
//        friendsArrayAdapter = new FriendsAdapter(getActivity(), R.id.fragment_place_friends_list, new ArrayList<Profile>(), FriendsAdapter.usage.SMALL_LIST);
